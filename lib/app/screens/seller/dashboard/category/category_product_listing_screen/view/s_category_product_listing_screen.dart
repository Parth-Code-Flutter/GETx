...
class SCategoryProductListingScreen
    extends GetView<SCategoryProductListingController> {
  SCategoryProductListingScreen({Key? key}) : super(key: key) {
              ...
              child: commonProductDataContainer(
                ...
                productOriginalPrice:
                    (productData.productVariants ?? []).isNotEmpty
                        ...
                        : 0,
                // 533.50
                productDiscountedPrice: (productData.productVariants ?? [])
                        .isNotEmpty
                    ?
                        double.parse(
