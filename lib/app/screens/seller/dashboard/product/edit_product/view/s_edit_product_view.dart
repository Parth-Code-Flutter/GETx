...
class SEditProductScreen extends GetView<SEditProductController> {
  ...
  //                 openBottomSheet();
  //               },
  //               child: SvgPicture.asset(kIconAddProduct, width: 105)),
  //         ),
  //       ],
  //     ),
  //   );
            ...
            child: Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton(
                  ...
                  isDense: true,
                  value: controller.selectedGstPrice.value,
                  items: controller.gstDataList
                      .map(
                        (gstValues) => DropdownMenuItem(
                          value: gstValues,
                          child: Padding(
                      ...
                      .toList(),
                  onChanged: (gstValues) {
                    controller.selectedGstPrice.value = gstValues!;
                    if (gstValues.priceInPer != kHintSelectGst) {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  maxLines: null,
                  onChanged: (value) {
                    if (controller.productSpecificationController.text
                        .trim()
                        .isEmpty) {
  ...
  updateProductButton() {
    return Padding(
      ...
      child: primaryButton(
        onPress: () {
          //controller.updateProductAPICall();
          controller.validateUserInput();
        },
        buttonTxt: kLabelUpdateProduct,
      ),
    );
  }
            ...
            Material(
              ...
              child: SizedBox(
                ...
                child: TextFormField(
                  ...
                  onChanged: (value) {
                    if (controller.gstController.text.trim().isEmpty) {
                      controller.gstStr.value = kErrorGst;
                      controller.isGstValidate.value = false;
                    } else {
                      controller.gstStr.value = '';
                      controller.isGstValidate.value = true;
                    }
                  },
                  decoration: const InputDecoration(
  ...
  qtyPriceDicount() {
    return Column(
      ...
      children: <Widget>[
        AbsorbPointer(
          absorbing: controller.shouldAbsorb,
          child: Row(
            children: [
              Container(
                width: 20,
          ...
          return Column(
            children: [
              ListView.builder(
                ...
                itemBuilder: (_, index) => controller.dynamicList[index],
              ),
              // Column(
              //   crossAxisAlignment: CrossAxisAlignment.start,
              //   children: [
              ...
              //       Obx(() {
              //         return Visibility(
              //           visible: controller.isSizeValidate.value == false,
              //           child: controller.sizeStr.value == ''
              //               ? Container()
              //               : Padding(
              //             padding: const EdgeInsets.all(4.0),
              //             child: Text(controller.sizeStr.value,
              //                 style: TextStyles.kH14RedBold400),
              //           ),
              //         );
              //       }),
              ...
              //     Obx(() {
              //       return Visibility(
              //         visible: controller.isQtyValidate.value == false,
              //         child: controller.qtyStr.value == ''
              //             ? Container()
              //             : Padding(
              //           padding: const EdgeInsets.all(4.0),
              //           child: Text(controller.qtyStr.value,
              //               style: TextStyles.kH14RedBold400),
              //         ),
              //       );
              //     }),
              //     Obx(() {
              //       return Visibility(
              //         visible: controller.isPriceValidate.value == false,
              //         child: controller.priceStr.value == ''
              //             ? Container()
              //             : Padding(
              //           padding: const EdgeInsets.all(4.0),
              //           child: Text(controller.priceStr.value,
              //               style: TextStyles.kH14RedBold400),
              //         ),
              //       );
              //     }),
              //     Obx(() {
              //       return Visibility(
              //         visible: controller.isDiscountValidate.value == false,
              //         child: controller.discountStr.value == ''
              //             ? Container()
              //             : Padding(
              //           padding: const EdgeInsets.all(4.0),
              //           child: Text(controller.discountStr.value,
              //               style: TextStyles.kH14RedBold400),
              //         ),
              //       );
              //     }),
