...
import '../../../../../widgets/profile_yello_bg.dart';
import '../controller/registration_as_buyer_controller.dart';

class RegistrationAsBuyerScreen extends GetView<RegistrationASBuyerController> {
  const RegistrationAsBuyerScreen({Key? key}) : super(key: key);
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                whiteTopWidget(txt: kLabelBuyerRegistration),
  ...
  Widget userNameTextField() {
    return Obx(() {
      return Focus(
        onFocusChange: (value) {
          if (value) {
            controller.userNameFieldColor.value = kColorPrimary;
          } else {
            controller.userNameFieldColor.value = kColorGrey9098B1;
          }
        },
        child: Padding(
              ...
              commonTextField(
                ...
                preFixIcon: Padding(
                  ...
                  child: SvgPicture.asset(
                    ...
                    //     ? kColorPrimary
                    //     :
                    color: controller.userNameFieldColor.value,
                  ),
                ),
              ),
              Obx(() {
  ...
  Widget mobileNumberTextField() {
    return Obx(() {
      return Focus(
        onFocusChange: (value) {
          if (value) {
            controller.mobileFieldColor.value = kColorPrimary;
          } else {
            controller.mobileFieldColor.value = kColorGrey9098B1;
          }
        },
        child: Padding(
              ...
              commonTextField(
                ...
                preFixIcon: Padding(
                  ...
                  child: SvgPicture.asset(
                    ...
                    //     ? kColorPrimary
                    //     :
                    color: controller.mobileFieldColor.value,
                  ),
                ),
              ),
              Obx(() {
  ...
  Widget userEmailTextField() {
    return Obx(() {
      return Focus(
        onFocusChange: (value) {
          if (value) {
            controller.userEmailFieldColor.value = kColorPrimary;
          } else {
            controller.userEmailFieldColor.value = kColorGrey9098B1;
          }
        },
        child: Padding(
          padding: const EdgeInsets.symmetric(horizontal: 34, vertical: 16),
              ...
              commonTextField(
                ...
                preFixIcon: Padding(
                  ...
                  child: SvgPicture.asset(
                    ...
                    //     ? kColorPrimary
                    //     :
                    color: controller.userEmailFieldColor.value,
                  ),
                ),
              ),
              Obx(() {
