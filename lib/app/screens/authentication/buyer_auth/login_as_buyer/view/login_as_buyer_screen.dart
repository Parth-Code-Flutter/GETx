...
class LoginAsBuyerScreen extends GetView<LoginAsBuyerController> {
  const LoginAsBuyerScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: SizedBox(
              ...
              child: Column(
                children: [
                  whiteTopWidget(txt: kLabelWelcomeToTSOFIE + ' - Buyer'),
                  const Padding(
