...
class OtpVerificationSellerScreen extends GetView<OtpVerificationSellerController> {

   OtpVerificationSellerScreen({Key? key}) : super(key: key){
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child:
                    primaryButton(buttonTxt: kLabelSubmit, onPress: () {
