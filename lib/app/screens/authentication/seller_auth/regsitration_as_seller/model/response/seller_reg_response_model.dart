...
SellerRegResponseModel sellerRegResponseModelFromJson(String str) =>
    SellerRegResponseModel.fromJson(json.decode(str));
class SellerRegResponseModel {
  int? responseCode;
  String? responseMessage;
  ResponseData? responseData;

  SellerRegResponseModel(
      {this.responseCode, this.responseMessage, this.responseData});

  SellerRegResponseModel.fromJson(Map<String, dynamic> json) {
